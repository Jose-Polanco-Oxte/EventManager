...
import jpolanco.applicationcore.user.domain.events.UserAddedRoles;
...
public class UserAddedRolesListener {
    ...
    public void handleUserAddedRoles(UserAddedRoles event) {
        log.info("User added roles: userId= {}, roles= {}, timeStamp= {}", event.getUserId(), event.getRoles(), event.getTimeStamp());
        ...
        dataChangeLog.setAction("ADD_ROLES");
