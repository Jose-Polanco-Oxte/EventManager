...
public class OwnEventQueryServiceImpl implements OwnEventQueryService {
    ...
    @Override
    public SlicePageResponseDto<EventResponse> getEventsByPages(String creatorId, int page, int size, String sortBy, String sortOrder) {
    ...
    @Override
    public CursorPageResponseDto<EventResponse, String> getEventsByCursorBased(String creatorId, String cursor, int size, String sortBy, String sortOrder) {
