...
public interface CGetEventsUC {
    /**
     * Retrieves all events, both public and private events, with cursor-based pagination and sorting options.
     *
     ...
     */
    CursorPageResult<Event, String> getEvents(String cursor, int size, String sortBy, String sortOrder);
}
